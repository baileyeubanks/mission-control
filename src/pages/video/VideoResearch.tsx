        ...
        <div className="space-y-4">
          ...
          <Card className="glass border-primary/10">
            ...
            <CardContent className="space-y-3 p-4 pt-0">
              ...
              <div
                ...
                className="cursor-pointer rounded-sm border-2 border-dashed border-white/10 bg-black/20 p-6 text-center transition-colors hover:border-primary/30 hover:bg-white/5"
              >
                      ...
                      <div className="space-y-1 max-h-32 overflow-y-auto">
                        {intelReport.shotList.slice(0, 6).map((shot, i) => (
                          <div key={i} className="flex items-center gap-2 text-xs">
                            <span className="shrink-0 rounded-sm bg-black/30 px-1.5 py-0.5 text-[9px] font-mono text-muted-foreground">{Math.floor(shot.timeStart)}s</span>
                  ...
                  {intelReport.viralMoments.length > 0 && (
                    <div>
                      ...
                      {intelReport.viralMoments.map((vm, i) => (
                        <div key={i} className="mb-1 rounded-sm border border-white/5 bg-black/20 p-2">
                          <div className="flex items-center gap-2">
          ...
          <Card className="glass border-white/5">
            ...
            <CardContent className="space-y-3 p-4 pt-0">
              ...
              <div className="space-y-2">
                {research.map((r) => (
                  <div key={r.id} className="rounded-sm border border-white/5 bg-black/20 p-3">
