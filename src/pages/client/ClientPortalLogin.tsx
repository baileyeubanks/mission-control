      ...
      <div className="w-full max-w-md">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-[10px] font-mono text-white/40 uppercase tracking-[0.3em]">Content Co-op</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6">
          {!result ? (
            ...
            <div className="space-y-4">
              ...
              <Button variant="ghost" className="w-full text-xs text-white/40" onClick={() => { setResult(null); setEmail(""); }}>
                Use different email
              </Button>
            </div>
          )}
        ...
        <p className="text-center text-[10px] font-mono text-white/20 mt-6 uppercase tracking-[0.2em]">
